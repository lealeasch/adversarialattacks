...
if [ $stage -le -2 ]; then
  ...
  tot_input_dim_half=$[$tot_input_dim_double/2]
...
LogComponent input-dim=$tot_input_dim_half
SpliceComponent input-dim=$tot_input_dim_half left-context=$splice_width right-context=$splice_width const-component-dim=$ivector_dim
...
#OverlapComponent input-dim=$tot_input_dim overlap=$overlap
#AbsComponent input-dim=$tot_input_dim_double
#AbsComponent input-dim=$tot_input_dim
#LogComponent input-dim=$tot_input_dim_half
